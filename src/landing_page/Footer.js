      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            ...
            <a>Fund transfer</a>
            <br />
            <a>60 day challenge</a>
          </div>
        </div>
        <div className="mt-5 text-muted " style={{ fontSize: ".65rem" }}>
        ...
        <div>
          <ul className="d-flex justify-content-center list-unstyled flex-wrap">
            ...
            <li className="me-3">
              <a href="" className="text-decoration-none text-muted">Polices & procedures</a>
            </li>
            <li className="me-3">
            ...
            <li className="me-3">
              <a href="" className="text-decoration-none text-muted">For investor's</a>
            </li>
            <li className="me-3">
              <a href="" className="text-decoration-none text-muted">attention</a>
            </li>
            <li className="me-3">
